 ...
 *
 * Las dos primeras ya se llaman "de Oro" en el catálogo ("MVP de Oro", "Fair
 * Play Oro"), así que pintarlas de verde contradecía su propio nombre.
 * "embajador" se suma por motivo de producto: es la recompensa de estatus del
 * sistema de referidos, y tiene que leerse como un logro de prestigio, no
 * como una insignia más.
 */
const GOLD_BADGE_SLUGS = new Set(['mvp_recurrente', 'fair_play_oro', 'embajador']);
